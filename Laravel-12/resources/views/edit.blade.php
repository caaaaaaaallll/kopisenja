...
$product->title) }}" placeholder="Masukkan Judul Product"> 
...
placeholder="Masukkan Description Product">{{ old('description', 
...
mt-2"> 
                                ...
                                <div class="col-md-6"> 
                                    <div class="form-group mb-3"> 
                                        <label 
class="font-weight-bold">STOCK</label> 
                                        <input type="number" 
class="form-control @error('stock') is-invalid @enderror" name="stock"
value="{{ old('stock', $product->stock) }}" placeholder="Masukkan Stock 
Product"> 
...
btn-primary me-3">UPDATE</button> 
